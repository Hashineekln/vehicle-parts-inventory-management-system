                        ...
                        {filteredUsers.map(user => (
                            <tr key={user.user_id} className='bg-white border-b dark:bg-gray-100 dark:border-gray-200'>
                                ...
                                <td className='py-4 px-6'>
                                    ...
                                    <button className='rounded-md bg-red-500 px-2 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-yellow-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ml-3' onClick={() => handleDelete(user.user_id)}>Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
